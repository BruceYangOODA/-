# -*- coding: utf-8 -*-
"""
Created on Fri Jul 31 11:25:55 2020
...
#pokemon_df = pd.read_csv('./../Lab3/pokemon.csv')  # 讀取寶可夢數據
pokemon_df = pd.read_csv('./pokemon.csv')  # 讀取800隻寶可夢數據
#print(pokemon_df.head())  # 顯示頭5比資料
pokemon_df= pokemon_df.set_index("#")  # 將索引設定為'#'列
# 原本 # 是第一欄的名稱 , 把 原本的第一欄設為 index

combats_df = pd.read_csv('./combats.csv')  # 讀取對戰數據
#print(combats_df.head())  # 顯示頭5比資料

#print(pokemon_df.info())  # 顯示精靈寶可夢的數據資訊
# #   Column      Non-Null Count  Dtype 
# 1   Type 1      800 non-null    object
# 2   Type 2      414 non-null    object
# Type 2 數量只有一半

# 透過傳入參數dropna=False，可以將缺失數據（NaN）也考慮進去，
# NaN代表寶可夢並沒有第二種屬性
# 顯示 Type2 值統計數據, Nan 有 386個。 386 + 414 = 800
...
# 1	Bulbasaur	9	13
#print(dict(enumerate(pokemon_df['Type 2'].cat.categories)))
...
# 計算欄位 HP 到 欄位 Gerneration的欄位平均值
std = pokemon_df.loc[:, 'HP':'Generation'].std()  # 計算
# # 計算欄位 HP 到 欄位 Gerneration的欄位標準差
...
# Model-1: 0.9549000263214111%
# Model-2: 0.9657999873161316%
